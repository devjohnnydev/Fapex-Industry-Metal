  ...
  return (
    <div className="min-h-screen overflow-x-hidden font-sans bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="flex items-center cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <img src="/fapex-logo-nobg.png" alt="Fapex" className="h-28 md:h-32 w-auto" />
          </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg bg-[#25D366] hover:bg-[#1ebe5d] transition-all hover:scale-110 active:scale-95"
      >
